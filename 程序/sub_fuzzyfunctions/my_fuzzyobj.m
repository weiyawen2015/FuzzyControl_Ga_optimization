...
width_x = [x(5) x(4) x(3) x(4) x(5)];%一半宽

% center_x
% width_x
% center_xmin = [10 65]/100;%PS PL的center
% center_xmax = [60 95]/100;%PS PL的center
% wid_xmin = [2/10 2/10 2/10];%ZO PS PL的width
% wid_xmax = [6 6 6]/10;%ZO PS PL的width
...
% width_x = [1/3 1/2 1/2 1/2 1/3];%一半宽
 rule ={@NL @NS @ZO @PS @PL};
%% 获得局部A B
